...
java -cp "../stanford-corenlp-full-2015-12-09/*" -mx8g edu.stanford.nlp.sentiment.SentimentTraining -numHid 25 -trainPath traindat0.tok -devPath testdat0.tok -train -model model.ser.gz
##fold 1

...
java -cp "*" edu.stanford.nlp.ie.crf.CRFClassifier -loadClassifier ../nlpdat/ner-model0.ser.gz -testFile ../nlpdat/traindat0.tok.tsv > ../nlpdat/res0.txt
...
#java -cp "*" edu.stanford.nlp.ie.crf.CRFClassifier -loadClassifier ../nlpdat/ner-model1.ser.gz -testFile ../nlpdat/traindat1.tok.tsv> ../nlpdat/res1.txt
#
#
##fold 2
...
#java -cp "*" edu.stanford.nlp.ie.crf.CRFClassifier -loadClassifier ../nlpdat/ner-model2.ser.gz -testFile ../nlpdat/traindat2.tok.tsv> ../nlpdat/res2.txt
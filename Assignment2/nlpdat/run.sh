...
#java -cp "*" edu.stanford.nlp.ie.crf.CRFClassifier -loadClassifier ../nlpdat/ner-model1.ser.gz -testFile ../nlpdat/testdat1.tok.tsv> ../nlpdat/res1.txt
#
#
##fold 2
...
#java -cp "*" edu.stanford.nlp.ie.crf.CRFClassifier -loadClassifier ../nlpdat/ner-model2.ser.gz -testFile ../nlpdat/testdat2.tok.tsv> ../nlpdat/res2.txt
...
java -cp "*" edu.stanford.nlp.ie.crf.CRFClassifier -prop ner0.prop
java -cp "*" edu.stanford.nlp.ie.crf.CRFClassifier -loadClassifier ner-model0.ser.gz -testFile ../nlpdat/traindat0.tok.tsv
...
java -cp "*" edu.stanford.nlp.ie.crf.CRFClassifier -prop ner1.prop
java -cp "*" edu.stanford.nlp.ie.crf.CRFClassifier -loadClassifier ner-model1.ser.gz -testFile ../nlpdat/traindat1.tok.tsv
...
java -cp "*" edu.stanford.nlp.ie.crf.CRFClassifier -prop ner2.prop
java -cp "*" edu.stanford.nlp.ie.crf.CRFClassifier -loadClassifier ner-model2.ser.gz -testFile ../nlpdat/traindat2.tok.tsv